...
public class RetrievalLayer {
	...
	public void targetUser(String userKey) 
	...
	throws NoUserTargetedException {
		if (!targeting_user) {
	...
	private void setUserName(String new_user_name) 
	throws NoUserTargetedException {
		if (!targeting_user) {
			throw new NoUserTargetedException();
		}
	...
	private void setFunds(String user_funds) 
	throws NoUserTargetedException {		
		if (!targeting_user) {
		throw new NoUserTargetedException();
	}
